...
__global__ void caffe_gpu_interp2_kernel(const int n, const float rheight, const float rwidth,
    ...
    Dtype *data2, const int x2, const int y2, const int height2, const int width2, const int Height2, const int Width2, const bool is_nearest, const int label_bound) {
  ...
  if (index < n) {
    ...
    Dtype h1lambda = h1r - h1;
    if (is_nearest) h1lambda = (int)(h1r - h1 + Dtype(0.5)); //jingzhang
    const Dtype h0lambda = Dtype(1.) - h1lambda;
    //
    const float w1r = rwidth * w2;
    const int w1 = w1r;
    const int w1p = (w1 < width1 - 1) ? 1 : 0;
    Dtype w1lambda = w1r - w1;
    if (is_nearest) w1lambda = (int)(w1r - w1 + Dtype(0.5)); //jingzhang
	...
	if (label_bound > 0 && pos2[0] > label_bound) pos2[0] = label_bound; //jingzhang
	pos1++;
	pos2++;
      }
    }
...
void caffe_gpu_interp2(const int channels,
  ...
  caffe_gpu_interp2_kernel<Dtype,packed><<<CAFFE_GET_BLOCKS(num_kernels), CAFFE_CUDA_NUM_THREADS>>>
    (num_kernels, rheight, rwidth, channels,
     ...
     data2, x2, y2, height2, width2, Height2, Width2, is_nearest, label_bound);
...
__global__ void caffe_gpu_interp2_kernel_backward(const int n, const float rheight, const float rwidth,
    ...
    const Dtype *data2, const int x2, const int y2, const int height2, const int width2, const int Height2, const int Width2, const bool is_nearest) {
  int index = threadIdx.x + blockIdx.x * blockDim.x;
  if (index < n) {
    const int w2 = index % width2; // 0:width2-1
    const int h2 = index / width2; // 0:height2-1
...
void caffe_gpu_interp2_backward(const int channels,
  ...
  caffe_gpu_interp2_kernel_backward<Dtype,packed><<<CAFFE_GET_BLOCKS(num_kernels), CAFFE_CUDA_NUM_THREADS>>>
    (num_kernels, rheight, rwidth, channels,
     data1, x1, y1, height1, width1, Height1, Width1,
     data2, x2, y2, height2, width2, Height2, Width2, is_nearest);
  CUDA_POST_KERNEL_CHECK;
}
...
// Explicit instances
template void caffe_gpu_interp2<float,false>(const int, const float *, const int, const int, const int, const int, const int, const int, float *, const int, const int, const int, const int, const int, const int, const bool, const int);
template void caffe_gpu_interp2<float,true>(const int, const float *, const int, const int, const int, const int, const int, const int, float *, const int, const int, const int, const int, const int, const int, const bool, const int);
template void caffe_gpu_interp2<double,false>(const int, const double *, const int, const int, const int, const int, const int, const int, double *, const int, const int, const int, const int, const int, const int, const bool, const int);
template void caffe_gpu_interp2<double,true>(const int, const double *, const int, const int, const int, const int, const int, const int, double *, const int, const int, const int, const int, const int, const int, const bool, const int);

template void caffe_gpu_interp2_backward<float,false>(const int, float *, const int, const int, const int, const int, const int, const int, const float *, const int, const int, const int, const int, const int, const int, const bool);
template void caffe_gpu_interp2_backward<double,false>(const int, double *, const int, const int, const int, const int, const int, const int, const double *, const int, const int, const int, const int, const int, const int, const bool);
