...
void caffe_cpu_interp2(const int channels,
    const Dtype *data1, const int x1, const int y1, const int height1, const int width1, const int Height1, const int Width1,
          Dtype *data2, const int x2, const int y2, const int height2, const int width2, const int Height2, const int Width2, const bool is_nearest); //jingzhang

template <typename Dtype, bool packed>
void caffe_gpu_interp2(const int channels,
    const Dtype *data1, const int x1, const int y1, const int height1, const int width1, const int Height1, const int Width1,
          Dtype *data2, const int x2, const int y2, const int height2, const int width2, const int Height2, const int Width2, const bool is_nearest, const int label_bound); //jingzhang
...
void caffe_cpu_interp2_backward(const int channels,
    ...
    const Dtype *data2, const int x2, const int y2, const int height2, const int width2, const int Height2, const int Width2, const bool is_nearest); //jingzhang
